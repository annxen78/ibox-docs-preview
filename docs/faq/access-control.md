...
Доступ к вашим данным есть только у тех сотрудников вашей компании, которым вы его предоставили. Это настраивается через роли — вы сами решаете, кто что может видеть и делать в системе (смотрите статью в базе знаний).
...
Чтобы узнать больше об ограничении доступа в системе, смотрите статью в базе знаний.
