...
:::info Информация
Назначить роли можно в разделе **Настройки → Сотрудники** ([Гайд по быстрому старту, часть 1](/docs/quick-start/part1-registration.md), и раздел [Настройки доступа в iBOX](/docs/knowledge/access/access.md))
:::
