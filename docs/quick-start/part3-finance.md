...
:::tip Совет
Чтобы дашборд показывал точную информацию, необходимо разобраться в его настройках. Чтобы узнать больше о дашборде и настроить его под свой бизнес, смотрите [инструкцию](knowledge/reports/dashboard).
:::
